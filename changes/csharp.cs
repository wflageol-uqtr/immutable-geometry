...
namespace HelloWorld
{
    ...
    record Point(int X, int Y, string Color = "black") : IMovable<Point>
    {
        ...
        {
            return string.Format($"Point({X}, {Y}, {Color})");
        }
    }
    ...
    record Rectangle(int X, int Y, int W, int H, string Color = "black") : IMovable<Rectangle>, IScalable<Rectangle>
    {
        private int Left => X;
        ...
        public override string ToString()
        {
            return string.Format($"Rectangle({X}, {Y}, {W}, {H}, {Color})");
        }
    }
    ...
    public class Program
    {
        ...
        {
            IMovable<Point> p = new Point(2, 2, "yellow");
            var p2 = p.Move(1, 2);
            var p3 = p.Rotate();
            ...
            var r = new Rectangle(2, 2, 3, 4, "green");
