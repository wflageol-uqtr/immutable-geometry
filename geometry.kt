...
data class Point(override val x: Int, override val y: Int) : Movable<Point> {
...
data class Rectangle(override val x: Int, override val y: Int, override val w: Int, override val h: Int) : Movable<Rectangle>, Scalable<Rectangle> {
    ...
    override fun toString(): String {
        return String.format("Rectangle(%d, %d, %d, %d)", x, y, w, h)
    }
}
